  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (bgRef.current) {
        ...
        bgRef.current.style.transform = `translateY(${offset}px) scale(${baseScale})`
      }
    }
      ...
      {content.backgroundImage && (
        <div
          ...
          style={{
            ...
            backgroundPosition: content.imagePosition ?? 'center',
            transform: `scale(${1.1 * (content.imageZoom ?? 1.0)})`,
